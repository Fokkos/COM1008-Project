...
//Adjusted for the extra feedback elements found in the game
...
function darkToggle(){
    if (dark == false){ //If the website is in light mode, enable dark mode
        ...
        //Elements for the feedback for the JS game
        document.getElementById("gameInput").style.color= "white";
        document.getElementById("gameInput").style.fontWeight= "bold";
        document.getElementById("gameFeedback").style.color= "white";
        document.getElementById("gameFeedback").style.fontWeight= "bold";
        ...
        document.getElementById("gameInput").style.color= "black";
        document.getElementById("gameInput").style.fontWeight= "normal";
        document.getElementById("gameFeedback").style.color= "black";
        document.getElementById("gameFeedback").style.fontWeight= "normal";
